...
const REVIEWS = [
  {
    ...
    rating: 5,
    date: 'June 2026',
    title: 'Complete game changer for trail running',
    body: 'After years of plantar fasciitis issues, switching to the TrailGrip finally allowed my feet to heal naturally. The wide toe box gave my toes room to actually function. I ran my first 10-mile trail without knee pain. Incredible.',
    verified: true,
    size: 'US Men 10',
  },
  {
    ...
    rating: 5,
    date: 'May 2026',
    title: 'Finally a minimalist shoe that looks great too',
    body: "The Summit Gray colorway is absolutely gorgeous. I get compliments every run. But more importantly — the ground feel is unlike anything I've tried. After a 2-week transition period, my running form transformed completely.",
    verified: true,
    size: 'US Women 8.5',
  },
  {
    ...
    body: "I was skeptical about spending $119 on barefoot shoes but these are built to last. The mesh upper breathes beautifully in Texas heat and the sole has handled rocky terrain, grass, and pavement equally well. Zero regrets.",
    verified: true,
    size: 'US Men 11',
  },
  {
    ...
    rating: 5,
    date: 'March 2026',
    title: 'My podiatrist approved this choice!',
    body: 'After my podiatrist recommended barefoot shoes for my overpronation, I researched extensively and chose Strident. The zero-drop heel really does change your gait patterns. My ankles and calves are stronger than ever.',
    verified: true,
    size: 'US Women 9',
  },
  {
    ...
    rating: 5,
    date: 'February 2026',
    title: 'Lived in these for 3 months',
    body: 'From trail running to casual walking to gym sessions — these do it all. The Stealth Black goes with everything. The 30-day guarantee gave me confidence to try them. I never needed it because these are perfect.',
    verified: true,
    size: 'US Men 9.5',
  },
  {
